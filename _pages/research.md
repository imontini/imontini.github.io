...
<details class="abstract">
  <summary><span class="btn btn--primary btn--small">Abstract</span></summary>
  <p>
  Does sustained state presence erode criminal governance more effectively than violent crackdowns? We argue that permanent police deployment undermines both criminal authority and the clandestine service provision that sustains it by displacing criminal actors and expanding state capacity. We test this argument by leveraging the staggered installation of Police Pacifying Units (UPPs) in <em>favelas</em> in Rio de Janeiro, Brazil. We estimate a difference-in-differences design using novel data, including more than 1.45 million complaints from the anonymous tipline <em>Disque Denúncia</em>. We find that UPP installation significantly reduced criminal governance and clandestine provision of transportation, gas, cable TV, and internet services. In contrast, pre-UPP violent crackdowns produced no such effects, suggesting that punitive operations alone are insufficient to displace entrenched criminal governance.
  </p>
</details>
