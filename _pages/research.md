...
Militias are mafia-type organizations, often formed by state agents, which have expanded rapidly across territories where residents lack access to the rule of law and state institutions are unable to limit the power of local bureaucrats and politicians. In Rio de Janeiro, *milícias* dominate large swaths of territory not only through coercion but through strategic political alliances. This paper theorizes and tests a mechanism linking militia territorial expansion to electoral dynamics: milícias deliver concentrated electoral support to politicians, who in turn shield their activities by manipulating bureaucratic appointments and enforcement priorities. Drawing on original geospatial and electoral data, we find that milícia entry into a new territory increases electoral concentration and gives strong electoral advantages to milícia-linked candidates with nearby turfs. We then show that the electoral capital of milícias is converted into political power through bureaucratic appointments that support milícia expansion and ensure impunity in its territories. Combined, our empirical tests support our integrated theoretical framework on the role of elections to strengthen milícias' objectives in democratic contexts. 
